...
class Coin2 : public CS230::GameObject
{
public:
    Coin2(math::vec2 startPos);
    GameObjectType GetObjectType() { return GameObjectType::Coin2; }
    std::string GetObjectTypeName() { return "Coin2"; }
